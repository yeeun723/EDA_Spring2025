...
ggplot(data=data.frame(x=0,y=0))+
  ...
  geom_text(
    ...
    ) # paste means to combine all the characters together
...
PeterPaul.chem.nutrients %>% 
  ...
  #month.abb means month abbreviation
...
## Exercise by my own 
#ex1 <- PeterPaul.chem.nutrients %>% 
  ggplot(aes(y=temperature_C, x=daynum, colour = year4)) +
  geom_point() +
  facet_wrap(var())
#print(ex1)
